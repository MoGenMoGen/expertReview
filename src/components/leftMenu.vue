  ...
  <div class="leftMenu">
    ...
    >
      <el-menu-item index="0" :class="currentIndex == '0' ? 'activeTwo' : ''">
        <img
          src="../assets/img/总览-未选.png"
          style="width: 18px; height: 18px; margin-left: 5px"
          v-if="currentIndex != '0'"
        />
        <img
          src="../assets/img/总览-选中.png"
          style="width: 18px; height: 18px; margin-left: 5px"
          v-if="currentIndex == '0'"
        />
      ...
      <el-submenu index="1">
        ...
        <el-menu-item-group>
          <el-menu-item
            index="1-1"
            :class="currentIndex == '1-1' ? 'active' : ''"
            >项目立项</el-menu-item
          >
          <el-menu-item
            index="1-2"
            :class="currentIndex == '1-2' ? 'active' : ''"
            >项目审批</el-menu-item
          >
          <el-menu-item
            index="1-3"
            :class="currentIndex == '1-3' ? 'active' : ''"
            >公告变更/澄清</el-menu-item
          >
          <el-menu-item
            index="1-4"
            :class="currentIndex == '1-4' ? 'active' : ''"
            >全部项目</el-menu-item
          >
        </el-menu-item-group>
      </el-submenu>
      ...
      <el-submenu index="3">
        ...
        <el-menu-item-group>
          <el-menu-item
            index="3-1"
            :class="currentIndex == '3-1' ? 'active' : ''"
            >专家选取规则
          </el-menu-item>
          <el-menu-item
            index="3-2"
            :class="currentIndex == '3-2' ? 'active' : ''"
            >专家库
          </el-menu-item>
          <el-menu-item
            index="3-3"
            :class="currentIndex == '3-3' ? 'active' : ''"
            >项目评定标准
          </el-menu-item>
          <el-menu-item
            index="3-4"
            :class="currentIndex == '3-4' ? 'active' : ''"
          >
            在线开标</el-menu-item
          >
        </el-menu-item-group>
