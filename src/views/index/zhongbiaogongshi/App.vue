							...
							<el-table :data="tableData" max-height="577" style="width: 100%" :cell-style="{
								...
								<el-table-column label="操作" min-width="100">
									<template slot-scope="scope">
										...
										<br>
										<el-button type="text" size="small" @click="handleClickShenhe(scope.row,0)" v-if="scope.row.announcementOfResults==0&&scope.row.announcementOfResultsStatus==0&&auth4"
